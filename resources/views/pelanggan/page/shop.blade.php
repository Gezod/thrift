                ...
                @foreach ($data as $p)
                    <div class="card" style="width:200px;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="m-0" style="font-size: 12px; color: grey;">{{ ucfirst($p->type) }}</p> <!-- Menampilkan tipe produk -->
                            <p class="m-0" style="font-size: 12px; color: grey;">{{ ucfirst($p->kategory) }}</p> <!-- Menampilkan tipe produk -->
                        </div>
